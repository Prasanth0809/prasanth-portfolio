...
In this project, I designed and implemented an enterprise-grade Azure cloud security environment from scratch — simulating how real organizations protect their cloud infrastructure using Azure-native services.
...
This project demonstrates practical experience across the full Azure security lifecycle:

- Designed and deployed a secure Azure network with VNet segmentation and NSG traffic control
- Built a centralized monitoring pipeline using Log Analytics and Diagnostic Settings
- Investigated security events using KQL queries in real Azure environments
- Configured automated incident detection with Azure Monitor Alert Rules
- Implemented least-privilege access control using custom RBAC roles
- Enforced subscription-wide governance using Azure Policy
- Assessed and documented security posture using Microsoft Defender for Cloud

This is real Azure Administrator work — built hands-on, documented thoroughly, and designed to reflect enterprise cloud security practices.
